...
--     yaml = {
--       schemas = {
--         kubernetes = 'templates/k8s_*.yaml',
...
--         ['file:///Users/jmaltin/.config/nvim/ftplugin/application_v1alpha1.json'] = 'application_*.{yml,yaml}',
--         ['file:///Users/jmaltin/.config/nvim/ftplugin/applicationset_v1alpha1.json'] = 'applicationset_*.{yml,yaml}',
--       },
--     },
--   },
-- }
